        ...
        <div class="col-md-12">
            <div class="card shadow p-4">
                <form method="POST" action="{{ route('sales.store') }}">
                    ...
                    <table class="table table-bordered" id="product_table">
                        ...
                        <tbody id="product_rows">
                            <tr>
                                ...
                                <td><input type="number" name="discount[]" step="0.01" class="form-control discount" value="0"></td>
                                <td><input type="number" name="line_total[]" class="form-control line_total" readonly></td>
                    ...
                    <button class="btn btn-primary mt-4">Submit Sale</button>
                </form>
            </div>
        </div>
    </div>
